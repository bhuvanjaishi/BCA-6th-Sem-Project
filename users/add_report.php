...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO reports (report_title, report_type, reporter, date) 
            VALUES ('$report_title', '$report_type', '$reporter', '$date')";

    if ($conn->query($sql) === TRUE) {
        echo "<script>alert('Report added successfully!'); window.location.href='manage-report.php';</script>";
    } else {
...
<div class="sidebar">
    ...
    <div id="add-report-container">
        <div id="top-bar">
            <a href="manage-report.php" id="back-link">← Back to Manage Reports</a>
